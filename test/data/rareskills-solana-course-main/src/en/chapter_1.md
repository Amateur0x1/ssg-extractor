...
**Exercise:** _Try renaming_ _`initialize`_ _in_ _`programs/day_1/src/lib.rs`_ _and_ _`initialize`_ _in_ _`tests/day_1.ts`_ _to become_ _`initialize2`_ _and run the test again. See the change marked in the_ _orange circles_ _below._
